...
router.get(
  "/space-bookings",
  adminAuthMiddleware,
  adminController.getAllSpaceBookings,
);

// Verify space booking
router.put(
  "/space-bookings/:id/verify",
  adminAuthMiddleware,
  adminController.verifySpaceBooking,
);
...
router.post(
  "/booking/:id/submit-notice",
  adminAuthMiddleware,
  upload("notice-pdfs").single("noticePdf"),
  adminController.submitNotice,
);
router.get(
  "/bookings/pending-notice",
  adminAuthMiddleware,
  adminController.getBookingsPendingNotice,
);
router.get(
  "/bookings/active-notice",
  adminAuthMiddleware,
  adminController.getNoticeActiveBookings,
);
...
router.post(
  "/push/register",
  adminAuthMiddleware,
  adminController.registerAdminPushToken,
);
router.post(
  "/push/subscribe",
  adminAuthMiddleware,
  adminController.subscribePushTopic,
);
router.post(
  "/push/unsubscribe",
  adminAuthMiddleware,
  adminController.unsubscribePushTopic,
);
...
router.post(
  "/push/send-topic",
  adminAuthMiddleware,
  adminController.sendTestPushToTopic,
);
router.post(
  "/push/send-token",
  adminAuthMiddleware,
  adminController.sendTestPushToToken,
);
