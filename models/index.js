...
MeetingRoom.hasMany(roomBooking, {
  foreignKey: "meetingRoomId",
  as: "bookings",
  onDelete: "CASCADE",
});
roomBooking.belongsTo(MeetingRoom, {
  foreignKey: "meetingRoomId",
  as: "meetingRoom",
});
